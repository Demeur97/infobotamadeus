...
def start(message):     
    bot.send_message(message.chat.id, 'Привет, {0.first_name}!\n\nДанный бот создан для хранения информации по игре Age of Magic. Чтобы начать пользоваться ботом напишите команду: <strong>Меню</strong>'.format(message.from_user), parse_mode="html")
